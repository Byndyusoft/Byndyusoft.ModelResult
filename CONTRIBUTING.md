# Contributing to Byndyusoft.ModelResult
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.ModelResult code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.ModelResult.git
```
